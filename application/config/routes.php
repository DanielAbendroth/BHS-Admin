...
$route['employees/success'] = 'admin/employees/success';
...
$route['etts/edit/section/(:num)/(:num)'] = 'admin/etts/create_section';
...
$route['etts/delete/task/(:num)/(:num)'] = 'admin/etts/delete_task';
$route['etts/approval/(:num)'] = 'admin/etts/approval';
$route['etts/rejection/(:num)'] = 'admin/etts/rejection';
$route['etts/exemption/(:any)/(:num)/(:num)'] = 'admin/etts/exemption';
